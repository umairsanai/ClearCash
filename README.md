...
The app includes four simple pop-up modals that handle everything:
1. **Add Pocket** – create new pockets.
2. **Manage Pocket** – rename, edit budgets, or delete pockets.
3. **Transfer Funds** – move money from your *Main Pocket* to another.
...
It really helps and keeps the motivation going :)
