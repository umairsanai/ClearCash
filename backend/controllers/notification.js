...
const markAllNotificationsRead = handleAsyncError(async (req, res, next) => {
...
const getCurrentMonthNotifications = handleAsyncError(async (req, res, next) => {
...
async function fetchCurrentMonthNotifications(user_id) {
    // TODO: Cast created_at into a string by created_at::TEXT
